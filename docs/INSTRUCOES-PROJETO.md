...
- **20/07/2026** — Fix (migration 005): `GRANT` de tabela ao `service_role` — o backend recebia `42501 permission denied for table users` no `/api/auth/me`, derrubando o login de todos os perfis. Isolamento segue app-layer (não mexe em RLS).
